...
const StickyFooter = () => {
  ...
  return (
    <div className="w-full">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2 text-[10px] md:text-xs">
        ...
        <div className="flex items-center gap-1 md:gap-2 flex-wrap">
          ...
          <Tag
            ...
            className="text-[10px] md:text-xs font-bold border-none m-0"
          >
            {growthPercent}%
          </Tag>
          <Tag color={getTagColor(strategyTag)} className="text-[10px] md:text-xs m-0 hidden sm:inline-block">
            {strategyTag}
          </Tag>
        </div>
