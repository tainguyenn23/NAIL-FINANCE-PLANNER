  ...
  return (
    <div className="space-y-6 pb-12">   
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 flex justify-between items-center sticky top-16 z-40 shadow-sm">
         <span className="font-bold text-gray-600 text-sm uppercase">Mục tiêu cần đạt:</span>
         <div className="flex gap-4">
            <span className="text-gray-500 text-sm">Doanh thu cần đạt: <b>${(inputs.goalRevenue || goal.targetRevenue).toLocaleString()}</b></span>
      ...
      <div className="border-l-4 border-pink-600 pl-4 py-1">
        <h3 className="text-xl font-black text-gray-800 m-0 uppercase">Các Kịch bản Tăng trưởng</h3>
      </div>
